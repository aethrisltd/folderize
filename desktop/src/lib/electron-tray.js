// https://github.com/sfatihk/electron-tray-window/blob/03e561b52f96cb4a2b5b991f183ae39ca38b216d/src/index.js#L153
...
function init(options) {
  ...
  options.window ? setWindow(options.window) : createMainWindow(options.windowUrl);
...
function createMainWindow(windowUrl) {
  window = undefined;
